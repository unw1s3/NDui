...
L["RaidBuffIndicatorTip"] = "|nПоказывать бафы и дебафы на рамках рейда"
...
L["FilterGoods"] = "Фильтр хозяйственных предметов"
L["FilterQuest"] = "Фильтр квестовых предметов"
L["FilterAnima"] = "Фильтр анима прелметов"
...
L["ShowRaidBuff"] = "Показывать Рейд Бафы"
L["ShowRaidBuffTip"] = "|n Показывать юафы на рамках рейда по логике Близзард, до 3х иконок.|n|n ЛУчше не использовать это с Corner BuffIndicator."
L["ShowRaidDebuff"] = "Показывать Рейд Дебафы"
L["ShowRaidDebuffTip"] = "|nПоказывать дебафы на рамках рейда согласно логике Близзард до 3х иконок"
L["RaidBuffSize"] = "Размер Рейдбафов"
L["RaidDebuffSize"] = "Размер Рейддебафов"
L["SmartRaid"] = "Рамки рейда по числу группп"
L["SmartRaidTip"] = "|nЕсли включено,показывает рамки рейда,если больше чем 5 членов в вашей группе.|nЕсли выключено,показывает рамки рейда, если вы в рейде, рамки группы если вы в группе.|n|nДостпуно тольок если Рамки группы включены."
L["EquipColor"] = "Рамки надетых вещей"
L["LanguageFilterTip"] = "Вым надо отключить языковой фильтр и перезагрузить клиент, чтобы получить доступ к поддержке Battle.Net."
L["SaveMailTarget"] = "Сохранить имя получателя"
L["BlockSpammer"] = "Заблокировать СПАМ"
L["BlockSpammerTip"] = "|nЕсли выбрано,повторяющиеся сообщения от спамеров будут заблокированы, вы больше не получите от них сообщения."
L["PetTrash"] = "Валюта для для петов"
L["PetTrashTip"] = "|nВ патче 9.1, вы можете купить 3 боевых питомца,используя специальную валюту. Оставляя это включенным, вы добавляете эту валюту в список исключений, чтобы она не была продана как Хлам."
L["MythicScore"] = "М+: %s"
L["MDScore"] = "Показывать М+"
L["MDScoreTip"] = "|nЕсли выбрано, показывает М+ рейтинг в текущем сезоне.|n Скрыть подсказку если М+ = 0."
